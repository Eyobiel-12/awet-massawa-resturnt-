  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        nameAmharic: "ካተና",
        price: "€5.85",
        description: "Injera soaked in spiced chili powder and clarified butter",
      },
      {
        name: "Massawa's Goe S' Nigh (spicy)",
        nameAmharic: "ማሳዋ ጎዕ ስንኝ",
        price: "€5.85",
        description: "Green peppers filled with herbs, onion, garlic, and tomato in olive oil. Served with injera",
        badges: ["Spicy"],
      },
      {
        name: "Massawa's Salad",
        price: "€5.00",
        description: "Fresh salad with cucumber, onion, tomato, and homemade dressing",
      },
      {
        name: "Soup of the day",
        price: "€5.00",
        description: "Ask our staff for today's special",
      },
    ],
  },
  {
...
const dessertCategories = [
  {
    ...
    items: [
      {
        name: "Vegan orange brownie",
        description: "Gluten free",
        price: "€6.00",
      },
      {
        name: "Chocolade chocolate",
        price: "€6.50",
      },
      {
  ...
  },
  {
    title: "Fruit Shakes",
    items: [
      { name: "Aardbei", nameEnglish: "Strawberry", price: "€8.25" },
      { name: "Banaan", nameEnglish: "Banana", price: "€6.00" },
      { name: "Avocado", price: "€8.25" },
      { name: "Mango", price: "€7.25" },
    ],
  },
]
